...
K = 10 # Number of flammable neighbors to explore
KF =30 # Number of urban neighbors of the flammable neighbors to explore 
limiar = 1.05 # Threshold for triangular inequality
limiartheta = 60  # Largest angle to be eligible to protect
QT = 10 # minimum contribution of one side to the triangle perimeter (%)
